...
2. go to the project root directory, and run `npm install mongoose express dotenv path hbs multer socket.io bcrypt` (make sure you have node package manager installed)
